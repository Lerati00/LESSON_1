module MenuConstants
  ...
  MAIN_MENU = <<~MENU 
   ...
   |Для перехода в подменю вагони введите [4]                 |
   |Для вывода более подробной информации введите [5]           |  
  ...
  CARRIAGES_MENU = <<~MENU
    ...
    |                 Меню вагонов                          |
     -------------------------------------------------------
    |Для создания нового вагона введите  [1]                |
    |Чтоби занять (места/обьем) в вагоне введите [2]        |
    |Чтоби вывести все вагони введите[3]                    | 
  ...
  TRAINS_MENU = <<~MENU
    ...
    |Чтоби вывести все вагоны в поезде введите [7]          |
    |Для для возврата в главное меню введите [0]            |
     -------------------------------------------------------  
  MENU
  ...
  HELP = <<~HELP
    ...
    Lesson - 7
       - Создавать вагоны [4][1]
       - Занимать место/обьем в вагонах [4][2]
       - Список всех поездов на станции [2][3]
       - Список всех вагонов в поезде [1][7]
  HELP

  INVALID_INDEX = "Не существующий индекс"
  CAR_SHORTAGE_ERROR = "Не достаточно вагонов"
  SELECT_TYPE_CARRIAGE = "Введите тип вагона (1 - Passenger/ 2 - Cargo)"
